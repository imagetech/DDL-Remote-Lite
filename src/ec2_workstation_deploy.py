...
CONDUCTOR_IP=''
TARGET_VPC=''
WORKSTATION_INSTANCE_TYPE=''

class Ec2DeployWorkstationStack(Stack):
    ...
    def setEc2RequestedParameters(self):
        ...
        self.ec2_requested_params['instance_name'] = 'Cloud Workstation'

        print("Set AMI:" + str(TARGET_AMI))
        self.ec2_requested_params['ami_name'] = TARGET_AMI

        self.ec2_requested_params['role_name'] = "DDL-SAT_Workstation"
        self.ec2_requested_params['profile'] = PROFILE

        # derived from account
        self.ec2_requested_params['req_instance_type'] = WORKSTATION_INSTANCE_TYPE
    ...
    def readSatelliteConfig(self):
        ...
        global HOME_VPC
        global WORKSTATION_INSTANCE_TYPE
        ...
        for satellite_region in satellite_regions:
            ...
            if satellite_region.get('region', None) == self.CDK_TARGET_REGION:
                WORKSTATION_INSTANCE_TYPE = satellite_region.get('WORKSTATION_INSTANCE_TYPE', None)
                TARGET_AMI = satellite_region.get('WORKSTATION_AMI', None)
                ...
                print("        -- WS_INS_TYPE:" + str(WORKSTATION_INSTANCE_TYPE))
                break   # found it
